...
from Python.utility.RechargeCalc_bugfix import RechargeCalc
...
sum(rmeteo.loc[locate1, r.find_SPcol(rmeteo)].values == Smeteo.loc[locate2, r.find_SPcol(Smeteo)].values)

t1 = rmeteo.loc[locate1, ['indicatore', r.find_SPcol(rmeteo)[0]]]
t2 = Smeteo.loc[locate2, ['indicatore', 'NOME_COM', r.find_SPcol(Smeteo)[0]]]
t3 = t1['SP1'] != t2['SP1']
