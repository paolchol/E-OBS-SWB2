# -*- coding: utf-8 -*-
"""
Creazione di dati netCDF compatibili con il software SWB2.0
- Dati di partenza: E-OBS
- Struttura basata su: dati Daymet forniti dal manuale come dati di prova
